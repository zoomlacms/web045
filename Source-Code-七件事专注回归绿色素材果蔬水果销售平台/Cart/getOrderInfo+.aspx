            ...
            <div class="indent">
                ...
                <div id="invoice_div">
                    ...
                    <div>
                        ...
                        <div>
                            <asp:TextBox runat="server" ID="InvoUserCode_T" class="form-control text_400 margin_t5" MaxLength="50" placeholder="纳税人识别号或统一社会信用代码" />
                        </div>
                        <div>
							...
							<a href="htt://http://www.gsxt.gov.cn" target="_blank">(查询统一社会信用代码)</a>
                        </div>
                    </div>
                </div>
            </div>
